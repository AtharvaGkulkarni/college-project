...
root.title("Arrhythmia Detection System")
...
#
lbl = tk.Label(root, text="Arrhythmia Detection System  ", font=('Georgia', 30,' bold '), height=1, width=25,bg="black",fg="white")
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='E:/Diabetic Detection/Diabetic Detection/Use-input_data_resized', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
