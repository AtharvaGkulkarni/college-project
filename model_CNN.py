...
path1 = 'E:/Kirti/Arrhythmia_Detection/Dataset/test_set/1'    #path of folder of images    
path2 = 'E:/Kirti/Arrhythmia_Detection/Dataset/test/1'  #path of folder to save images    
